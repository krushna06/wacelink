...
// This is the modded version of PWSL (typescript variant) for running on Wacelink
...
export type WacelinkWebsocketOptions = {
  timeout?: number
  headers?: Record<string, unknown>
}

export type WacelinkWebsocketFHInfo = {
  opcode: number
  fin: boolean
...
export enum WacelinkWebsocketState {
  WAITING = 'WAITING',
...
function parseFrameHeader(info: WacelinkWebsocketFHInfo, buffer: Buffer) {
...
export class WacelinkWebsocket extends EventEmitter {
	protected socket: Socket | null
	protected continueInfo: ContinueInfoType
	protected state: WacelinkWebsocketState
   ...
   */
    ...
    protected options: WacelinkWebsocketOptions
	) {
		super()
		this.socket = null
		this.continueInfo = {
		...
		this.state = WacelinkWebsocketState.WAITING
   ...
   */
	...
	protected async checkData() {
		...
		if (data && this.state === 'WAITING') {
			this.state = WacelinkWebsocketState.PROCESSING
