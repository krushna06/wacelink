/**
 * All wacelink manager events
 */
export enum WacelinkEvents {
  Debug = 'debug',
  // Node
...
/**
 * Wacelink node connect state
 */
export enum WacelinkConnectState {
  Connected,
  Disconnected,
  Closed,
}
...
/**
 * Wacelink plugin type
 */
export enum WacelinkPluginType {
  Default = 'default',
  SourceResolver = 'sourceResolver',
}

/**
 * Wacelink player connect state
 */
export enum WacelinkPlayerState {
  CONNECTED,
  DISCONNECTED,
  DESTROYED,
}
...
/** @ignore */
export const WacelinkFilterData = {
	clear: {},
...
export type WacelinkFilterMode = keyof typeof WacelinkFilterData
